...
const HomePage: React.FC = (props) => {
  ...
  const handleSubmitRelease = () => {
    ...
    Http.post('/article/addArticle', params).then((res: any) => {
      setTimeout(() => {
        if (res.status === 200) {
          toast.success("发布成功！", {
            position: toast.POSITION.BOTTOM_CENTER,
      ...
      <div className="content-warp">
        <div className="title-content">
          <div className="title-box">
            <input className="title" type="text" placeholder="请输入标题" onChange={handleChangeTitle} />
          </div>
          <ReactWEditor
        ...
        <div className="other-info">
          <h3>文章发布在</h3>
          <Select onChange={handleChangeType} placeholder="请选择板块">
